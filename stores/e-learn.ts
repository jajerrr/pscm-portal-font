...
export const useELearnStore = defineStore("e-learn", {
  ...
  mainContentData:[
    { path:"/e-learning/cb", 
      toppic:"CB", 
      img: "/images/e-learing/content1.jpg", 
      file: "5 Toppic",
      time: "16 sec", 
      content: "This course examines the carotid body (CB), a multimodal sensory organ located at the junction of the common carotid artery." },
