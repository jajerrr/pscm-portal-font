<template>
  <div class="w-full h-auto  text-[#2B2B2B] SF-TH overflow-hidden scrollContainer ">
    ...
    <div class="cb-main-content ">
      <div class="w-full  h-auto cb-bg bg-cover">

        <!-- Image and Card Section -->
        <div class="f-row flex-wrap items-center justify-center  mr-[20%] sm-cb-top px-10 pt-[33vw]">
          <!-- Left Image Section with Transition -->
          <div class="flex justify-start nm-ab   p-[3rem]">
            <div class="transition-wrapper" :class="{ 'fade': isTransitioning }">
              <img :src="selectedImage" alt="Course Image" class="  w-[60vw] sm-img-cb-course h-full  transition-image"
      ...
      <div class="px-[10rem] sm-topic-cb  relative mt-[30vw] pb-[5rem]">
      ...
      <div class="px-[10rem] sm-topic-cb mt-[5rem] pb-[5rem]">
        ...
        <!-- <div class="mt-[5%] f-row gap-5 flex-wrap">
          <div v-for="(left, index) in ContentStore.mainContentData" :key="index">

           

              <div v-if=" index >= 0 , index <= 1" class="SF-TH cursor-pointer">
                <NuxtLink :to="left.path" style="align-content: center; width: 50% !important;">
                  <div class="text-[#5A5A5A] relative">

                    <img :src="getContentImageSrc(left.img)"
                      class="w-[20vw] h-auto justify-center transition "
                      />
                    <div class="f-col gap-2 mt-2  w-[70%]">
                      <p class="text-nm SF-TH-Semi">
                        {{ left.toppic }}</p>
                      <div class="">
                    ...
                    <div class="content-re SF-TH cursor-pointer wrap">
                        <NuxtLink :to="left.path">
                            <div class="text-[#5A5A5A] f-col content-center relative " style="align-content: center;">
                                ...
                                <img :src="getContentImageSrc(left.img)"
                                    class="w-full h-auto justify-center transition ease-in-out inner-img "
